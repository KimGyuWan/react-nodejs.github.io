                  ...
                  <ul>
                    ...
                    <li className="item my-2">
                      <div className="input_box align-items-center"> 종류:
                        ...
                        <input type="radio" name="chk2" id="chk2" defaultValue="" />
                      </div>
                    </li>
                    <li className="item my-2">
                      <div className="input_box align-items-center ">연령:
                        <label htmlFor="chk3">이유기:</label>
                        <input type="radio" name="chk3" id="chk3" defaultValue="" defaultChecked />
                        <label htmlFor="chk4">성장기:</label>
                        <input type="radio" name="chk4" id="chk4" defaultValue="" />
                        <label htmlFor="chk5">성년기:</label>
                        <input type="radio" name="chk5" id="chk5" defaultValue="" />
                      </div>
                    </li>
                    <li className="item my-2">
                      <div className="input_box  align-items-center "> 유형:
                        <label htmlFor="chk6">건식:</label>
                        <input type="radio" name="chk6" id="chk6" defaultValue="" defaultChecked />
                        <label htmlFor="chk7">냉동:</label>
                        <input type="radio" name="chk7" id="chk7" defaultValue="" />
                      </div>
                    </li>
                  </ul>
                </div>
